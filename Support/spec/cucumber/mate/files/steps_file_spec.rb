          ...
          it "should return a list of step definitions included in this file" do
            @steps_file.step_definitions.should ==
              [
                ...
                {:step => @step, :type => 'When', :pattern => "Basic when", :pattern_text => "Basic when", :line => 17, :file_path => @steps_file.full_file_path, :group_tag => 'basic'},
                {:step => @step, :type => 'Then', :pattern => "Basic then", :pattern_text => "Basic then", :line => 21, :file_path => @steps_file.full_file_path, :group_tag => 'basic'},
              ]
          end
        end
      end
