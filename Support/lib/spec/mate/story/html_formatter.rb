# TODO: Remove this formatter and create a better standalone TM formatter.
# This formatter is from rspec 1.1.4. The HtmlFormatter in edge rspec (1.1.5 dev) is in a bit
# of flux so to avoid issues I'm including this formatter until that has stabilized.
require 'erb'
...
module Spec
  module Mate
    module Story
      class HtmlFormatter < Spec::Runner::Formatter::BaseTextFormatter
          include ERB::Util
